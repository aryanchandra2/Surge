...
namespace MilkShake.Demo
{
    ...
    {
        [SerializeField]
        private readonly Slider strengthSlider;
        [SerializeField]
        private readonly Text strengthText;
        [SerializeField]
        private readonly Slider roughnessSlider;
        [SerializeField]
        private readonly Text roughnessText;
        [SerializeField]
        private readonly Slider fadeInSlider;
        [SerializeField]
